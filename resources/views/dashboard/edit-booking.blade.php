                    ...
                    <ul>
                        ...
                        <li class="submenu"> <a href="#"><i class="fas fa-suitcase"></i> <span> Booking </span>
                            ...
                            <ul class="submenu_class" style="display: none;">
                                ...
                                <li><a class="active" href="edit-booking"> Booking Approved </a></li>
            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <div class="mt-5">
                                <h4 class="card-title float-left mt-2">Bookings have approved</h4>
                            </div>
                        </div>
                        {{-- SEARCH BAR --}}
                                            ...
                                            @foreach ($bookings as $booking)
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-danger btn-sm"
                                                        onclick="confirmDelete('{{ route('booking.delete', $booking->id) }}')">Delete</button>
                                                </td>
